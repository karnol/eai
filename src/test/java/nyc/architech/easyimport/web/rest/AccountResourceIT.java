...
import nyc.architech.easyimport.web.rest.errors.ExceptionTranslator;
...
//        validUser.setImageUrl("http://placehold.it/50x50");
        ...
        assertThat(userRepository.findOneByEmailIgnoreCase("test-register-valid@example.com").isPresent()).isFalse();
        ...
        assertThat(userRepository.findOneByEmailIgnoreCase("test-register-valid@example.com").isPresent()).isTrue();
    }
...
//        secondUser.setLastModifiedDate(firstUser.getLastModifiedDate());
    ...
    @Test
    @Transactional
    @Disabled //TODO: cause we activate user by default!!
