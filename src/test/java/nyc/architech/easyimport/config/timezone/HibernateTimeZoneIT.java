package nyc.architech.easyimport.config.timezone;

import nyc.architech.easyimport.EasyimportApp;
import nyc.architech.easyimport.repository.timezone.DateTimeWrapper;
import nyc.architech.easyimport.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM _date_time_wrapper where id=%d", fieldName, id);
    }
